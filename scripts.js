...
function checkInputs() {
  ...
  if (passwordValue === "") {
    setErrorFor(password, "Favor, insira uma senha");
  ...
  if (passwordConfirmationValue === "") {
    setErrorFor(passwordConfirmation, "Por favor, confirme a senha.");
  ...
  if (formIsValid) {
    ...
    console.log("Há erros nos dados informados pelo usuário");
  }
}
